...
// Serve Static Files from Respective Updated Folders
...
// -----------------------------------------------------------------------------
// HTML Page Routes (Mapped with correct folder names)
// -----------------------------------------------------------------------------
...
// System Owner PIN Verification Endpoint (.env থেকে পিন চেক নিশ্চিত করা হয়েছে)
...
// A. User Registration Endpoint (Secure for users, flexible for admins)
app.post('/api/register', async (req, res) => {
  try {
    const { fullName, nidNumber, phoneNumber, email, gender, dob, bloodGroup, presentAddress, password, createdBy } = req.body;

    // Bangladeshi Phone Number Validation (013 - 019, 11 digits)
...
// F. Save Credential Endpoint (User Vault Data)
...
// G. Admin APIs: Fetch Only Admin-Created Users & Integrated Vault Data
