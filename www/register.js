...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    // যদি কোনো কারণে উইন্ডোতে সুপাবেস না পাওয়া যায় (মোবাইল WebView-এর জন্য বিশেষ ব্যবস্থা)
    if (!supabase) {
        console.warn("Supabase script not found initially. Attempting dynamic load...");
        
        // ডায়নামিকভাবে সিডিএন স্ক্রিপ্ট লোড করার চেষ্টা
    ...
    // Form Submission Handler (Supabase Registration)
    if (registerForm) {
        registerForm.addEventListener('submit', async (e) => {
            e.preventDefault();

            // সাবমিট করার সময়ও যদি সুপাবেস না থাকে আরেকবার চেক করা
            if (!supabase) {
                supabase = initSupabase();
            }
            ...
            try {
                ...
                // Check Duplicate User in Supabase
